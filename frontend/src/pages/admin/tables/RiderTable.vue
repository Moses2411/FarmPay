    ...
    <table class="w-full text-left border-collapse">
      <thead>
        <tr class="border-b border-white/10 bg-white/5">
          ...
          <!-- <th class="px-6 py-4 text-xs font-bold uppercase tracking-widest text-[#7bc95a]">Action</th> -->
        </tr>
      </thead>
          ...
          <td class="px-6 py-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <div class="text-[10px] text-white/30 uppercase font-bold tracking-tight">Active Member</div>
              </div>
            </div>
          </td>
...
<!-- 
          <td class="px-6 py-4">
            <div class="flex gap-2">
              ...
              <button 
                @click="emit('delete', rider.id)"
                class="p-2 hover:bg-red-500/10 rounded-lg text-red-400/60 hover:text-red-400 transition-colors"
              >
                <Trash2 :size="18" />
              </button>
            </div>
